...
thresh_cases_i = find(data_gt_thresh,1);
thresh_date_cases = oCanada.dates(thresh_cases_i); 
...
thresh_cases_i = find(data_gt_thresh,1);
thresh_date_deaths = oCanada.dates(thresh_cases_i); 
...
thresh_cases_i = find(data_gt_thresh,1);
thresh_date_deaths_norm = oCanada.dates(thresh_cases_i); 
...
fig2 = figure(2);
if CTRL_SAVE_PLOT, fig2.WindowStyle = 'normal'; fig2.Position = [140 378 760 720]; end %default: [440 378 560 420] %'docked')
leg = {};
for i = 1:length(R)
...
fig3 = figure(3);
if CTRL_SAVE_PLOT, fig3.WindowStyle = 'normal'; fig3.Position = [240 378 760 720]; end %default: [440 378 560 420] %'docked')
leg = {};
for i = 1:length(R)
...
fig4 = figure(4);
if CTRL_SAVE_PLOT, fig4.WindowStyle = 'normal'; fig4.Position = [340 378 760 720]; end %default: [440 378 560 420] %'docked')
leg = {};
for i = 1:length(R)
...
fig5 = figure(5);
if CTRL_SAVE_PLOT, fig5.WindowStyle = 'normal'; fig5.Position = [440 378 760 720]; end %default: [440 378 560 420] %'docked')
leg = {};
for i = 1:length(R)
...
fig6 = figure(6);
if CTRL_SAVE_PLOT, fig6.WindowStyle = 'normal'; fig6.Position = [540 378 760 720]; end %default: [440 378 560 420] %'docked')
leg = {};
for i = 1:length(R)
...
fig16 = figure(16);
if CTRL_SAVE_PLOT, fig16.WindowStyle = 'normal'; fig16.Position = [540 378 760 720]; end %default: [440 378 560 420] %'docked')
leg = {};
for i = 1:length(R)
...
if CTRL_SAVE_PLOT
    ...
    if exist('fig1','var'), saveas(fig1,sprintf('%s/covid19-1-cases.jpg',out_folder)); end  
    if exist('fig2','var'), saveas(fig2,sprintf('%s/covid19-2-cases-shift.jpg',out_folder)); end  
    if exist('fig3','var'), saveas(fig3,sprintf('%s/covid19-3-deaths.jpg',out_folder)); end  
    if exist('fig4','var'), saveas(fig4,sprintf('%s/covid19-4-deaths-shift.jpg',out_folder)); end  
    if exist('fig5','var'), saveas(fig5,sprintf('%s/covid19-5-deaths-norm.jpg',out_folder)); end  
    if exist('fig6','var'), saveas(fig6,sprintf('%s/covid19-6-deaths-norm-shift.jpg',out_folder)); end  
    if exist('fig12','var'), saveas(fig12,sprintf('%s/covid19-2b-deaths-diff-norm-shift.jpg',out_folder)); end  
    if exist('fig16','var'), saveas(fig16,sprintf('%s/covid19-6b-deaths-diff-norm-shift.jpg',out_folder)); end  
end
